We can use an event function to stop the computation when our one of our end conditions is met. Two events should stop the calculation, the fox catching the rabbit, and the rabbit reaching the burrow.
